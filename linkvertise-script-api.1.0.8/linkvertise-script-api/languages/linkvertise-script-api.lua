...
local trueData = "173f5b3134254f748f6070de2c32e11d"
local falseData = "58089c7f50a645fb91aae5e75d0f2af3"
...
local function loadKeySystem()
    ...
    local CheckKey = Tabs.KeySys:AddButton({
        ...
        Callback = function()
            local response = KeyGuardLibrary.validateDefaultKey(InputKey.Value) or KeyGuardLibrary.validatePremiumKey(InputKey.Value)
    ...
    local GetKey = Tabs.KeySys:AddButton({
        ...
        Callback = function()
            ...
            showNotification("Copied!", "Link Coppied..Paste on your browser", "rbxassetid://123458")
        end
    })
...
if isfile(Directory) then
    ...
    if storedKey and storedKey ~= "" then
        local response = KeyGuardLibrary.validateDefaultKey(storedKey) or KeyGuardLibrary.validatePremiumKey(storedKey)
        if response == trueData then
